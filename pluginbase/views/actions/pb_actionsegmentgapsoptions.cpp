#include "pb_actionsegmentgapsoptions.h"
#include "ui_pb_actionsegmentgapsoptions.h"

#include "actions/pb_actionsegmentgaps.h"

#include <QColorDialog>

PB_ActionSegmentGapsOptions::PB_ActionSegmentGapsOptions(const PB_ActionSegmentGaps *action, float initZvalue) :
    CT_GAbstractActionOptions(action),
    ui(new Ui::PB_ActionSegmentGapsOptions())
{
    ui->setupUi(this);
...
PB_ActionSegmentGapsOptions::~PB_ActionSegmentGapsOptions()
{
    delete ui;
}

float PB_ActionSegmentGapsOptions::getHeight()
{
    return ui->dsb_height->value();
}

int PB_ActionSegmentGapsOptions::getActiveCluster()
{
    return ui->sb_activeCluster->value();
}

bool PB_ActionSegmentGapsOptions::getShowClustersOnly()
{
    return ui->pb_showClusters->isChecked();
}


PB_ActionSegmentGapsOptions::Mode PB_ActionSegmentGapsOptions::getMode()
{
    return _mode;
}

PB_ActionSegmentGapsOptions::DrawingGrid PB_ActionSegmentGapsOptions::getDrawingGrid()
{
    return _drawingGrid;
}

void PB_ActionSegmentGapsOptions::setHeight(float h)
{
    ui->dsb_height->setValue(h);
    emit parametersChanged();
}

void PB_ActionSegmentGapsOptions::setActiveCluster(int cluster)
{
    ui->sb_activeCluster->setValue(cluster);
    emit parametersChanged();
}

void PB_ActionSegmentGapsOptions::setClusterNumber(int nb)
{
    ui->sb_activeCluster->setMaximum(nb);
    emit parametersChanged();
}

void PB_ActionSegmentGapsOptions::setMode(Mode mode)
{
    _mode = mode;
...
void PB_ActionSegmentGapsOptions::setDrawingGrid(DrawingGrid drawingGrid)
{
...
double PB_ActionSegmentGapsOptions::getHSingleStep()
{
...
int PB_ActionSegmentGapsOptions::getPencilSize()
{
    return ui->sb_pencilSize->value();
}

bool PB_ActionSegmentGapsOptions::redForSelection()
{
    return ui->pb_activeClusterColor->isChecked();
}

bool PB_ActionSegmentGapsOptions::isFillModeFull()
{
    return ui->pb_fillMode->isChecked();
}

void PB_ActionSegmentGapsOptions::increaseHValue()
{
    ui->dsb_height->setValue(ui->dsb_height->value() + getHSingleStep());
    emit parametersChanged();
}

void PB_ActionSegmentGapsOptions::decreaseHValue()
{
    ui->dsb_height->setValue(ui->dsb_height->value() - getHSingleStep());
    emit parametersChanged();
}

void PB_ActionSegmentGapsOptions::increasePencilSizeValue()
{
    ui->sb_pencilSize->setValue(ui->sb_pencilSize->value() + 1);
    emit parametersChanged();
}

void PB_ActionSegmentGapsOptions::decreasePencilSizeValue()
{
    ui->sb_pencilSize->setValue(ui->sb_pencilSize->value() - 1);
    emit parametersChanged();
}

void PB_ActionSegmentGapsOptions::setActiveClusterColor(const QColor* color)
{  
    if (redForSelection())
    {
...
void PB_ActionSegmentGapsOptions::setUndoRedo(bool undo, bool redo)
{
    ui->pb_undo->setEnabled(undo);
    ui->pb_redo->setEnabled(redo);
}

void PB_ActionSegmentGapsOptions::on_pb_pickup_clicked()
{
    setMode(CHOOSECLUSTER);
}

void PB_ActionSegmentGapsOptions::on_pb_addCluster_clicked()
{
    setMode(DRAWLIMITS);
    emit askForClusterCreation();
}

void PB_ActionSegmentGapsOptions::on_pb_drawLimit_clicked()
{
    setMode(DRAWLIMITS);
}

void PB_ActionSegmentGapsOptions::on_pb_fill_clicked()
{
    setMode(FILLAREA);
}

void PB_ActionSegmentGapsOptions::on_pb_freemove_clicked()
{
    setMode(FREEMOVE);
}

void PB_ActionSegmentGapsOptions::on_pb_centerOnCell_clicked()
{
    setMode(CHANGECENTERCELL);
}

void PB_ActionSegmentGapsOptions::on_rb_clusters_clicked()
{
    setDrawingGrid(CLUSTERS);
}

void PB_ActionSegmentGapsOptions::on_rb_mns_clicked()
{
    setDrawingGrid(HEIGHT);
}

void PB_ActionSegmentGapsOptions::on_rb_density_clicked()
{
    setDrawingGrid(DENSITY);
}

void PB_ActionSegmentGapsOptions::on_sb_activeCluster_valueChanged(int arg1)
{
    Q_UNUSED(arg1)
...
void PB_ActionSegmentGapsOptions::on_dsb_height_valueChanged(double arg1)
{
    Q_UNUSED(arg1)
    emit parametersChanged();
}

void PB_ActionSegmentGapsOptions::on_pb_showClusters_clicked()
{
    emit parametersChanged();
}
...
void PB_ActionSegmentGapsOptions::changeSingleStep(int button)
{
    Q_UNUSED(button);
...
void PB_ActionSegmentGapsOptions::on_pb_merge_clicked()
{
