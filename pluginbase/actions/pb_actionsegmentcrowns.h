#ifndef PB_ACTIONSEGMENTCROWNS_H
#define PB_ACTIONSEGMENTCROWNS_H


#include "views/actions/pb_actionsegmentcrownsoptions.h"
#include "ct_actions/abstract/ct_abstractactionforgraphicsview.h"
#include "ct_itemdrawable/ct_grid2dxy.h"

#include <QRect>

class PB_ActionSegmentCrowns : public CT_AbstractActionForGraphicsView
{
    Q_OBJECT
public:
    ...
    PB_ActionSegmentCrowns(const CT_Grid2DXY<int>* densityGrid, const CT_Grid2DXY<double>* mnsGrid, CT_Grid2DXY<int>* clustersGrid);

    ~PB_ActionSegmentCrowns();
    ...
    void drawLimit(PB_ActionSegmentCrownsOptions *option, size_t maxCol, size_t maxRow);
    ...
    void drawPencil(PainterInterface &painter, PB_ActionSegmentCrownsOptions *option, const double &resolution, const double &z_val);
...
#endif // PB_ACTIONSEGMENTCROWNS_H
