...
public:
    ...
    PB_ActionSegmentCrowns(const CT_Grid2DXY<int>* densityGrid, const CT_Grid2DXY<float>* mnsGrid, CT_Grid2DXY<int>* clustersGrid);
    ...
    void drawPencil(PainterInterface &painter, PB_ActionSegmentCrownsOptions *option, const float &resolution, const double &z_val);
