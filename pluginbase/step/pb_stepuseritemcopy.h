#ifndef PB_STEPUSERITEMCOPY_H
#define PB_STEPUSERITEMCOPY_H
...
class PB_StepUserItemCopy: public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    PB_StepUserItemCopy(CT_StepInitializeData &dataInit);
