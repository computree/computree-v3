#ifndef PB_STEPCORRECTALSPROFILE_H
...
/*!
 * \class PB_StepCorrectALSProfile
 * \ingroup Steps_PB
...
class PB_StepCorrectALSProfile: public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    PB_StepCorrectALSProfile(CT_StepInitializeData &dataInit);
...
#endif // PB_STEPCORRECTALSPROFILE_H
