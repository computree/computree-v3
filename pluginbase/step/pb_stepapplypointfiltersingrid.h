#ifndef PB_STEPAPPLYPOINTFILTERSINGRID_H
#define PB_STEPAPPLYPOINTFILTERSINGRID_H
...
class PB_StepApplyPointFiltersInGrid: public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    PB_StepApplyPointFiltersInGrid(CT_StepInitializeData &dataInit);
    ~PB_StepApplyPointFiltersInGrid();
...
#endif // PB_STEPAPPLYPOINTFILTERSINGRID_H
