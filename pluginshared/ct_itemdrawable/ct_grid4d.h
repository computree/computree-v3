...
private:
    ...
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_DIMENSION, &CT_Grid4D<DataT>::wdim, QObject::tr("W dimension"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_X_DIMENSION, &CT_Grid4D<DataT>::xdim, QObject::tr("X dimension"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_Y_DIMENSION, &CT_Grid4D<DataT>::ydim, QObject::tr("Y dimension"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_Z_DIMENSION, &CT_Grid4D<DataT>::zdim, QObject::tr("Z dimension"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_COORDINATE, &CT_Grid4D<DataT>::minW, QObject::tr("W min"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_X, &CT_Grid4D<DataT>::minX, QObject::tr("X min"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_Y, &CT_Grid4D<DataT>::minY, QObject::tr("Y min"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_Z, &CT_Grid4D<DataT>::minZ, QObject::tr("Z min"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_RESOLUTION, &CT_Grid4D<DataT>::wres, QObject::tr("Resolution W"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_X_RESOLUTION, &CT_Grid4D<DataT>::xres, QObject::tr("Resolution X"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_Y_RESOLUTION, CT_Grid4D<DataT>::yres, QObject::tr("Resolution Y"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_Z_RESOLUTION, &CT_Grid4D<DataT>::zres, QObject::tr("Resolution Z"))
    CT_DEFAULT_IA_V2(CT_Grid4D<DataT>, CT_AbstractCategory::DATA_NA, &CT_Grid4D<DataT>::NA, QObject::tr("NA"))
