...
private:
    ...
    CT_DEFAULT_IA_V3(CT_Grid4D<DataT>, CT_AbstractCategory::staticInitDataX(), &CT_Grid4D<DataT>::minX, QObject::tr("X min"), "xmin")
    CT_DEFAULT_IA_V3(CT_Grid4D<DataT>, CT_AbstractCategory::staticInitDataY(), &CT_Grid4D<DataT>::minY, QObject::tr("Y min"), "ymin")
    CT_DEFAULT_IA_V3(CT_Grid4D<DataT>, CT_AbstractCategory::staticInitDataZ(), &CT_Grid4D<DataT>::minZ, QObject::tr("Z min"), "zmin")
