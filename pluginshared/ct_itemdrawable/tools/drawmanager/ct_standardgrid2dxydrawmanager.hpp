...
CT_StandardGrid2DXYDrawManager<DataT>::CT_StandardGrid2DXYDrawManager(QString drawConfigurationName, bool mapMode, bool scale)
    : CT_StandardAbstractItemDrawableWithoutPointCloudDrawManager(drawConfigurationName.isEmpty() ? QString("CT_Grid2DXY<%1>").arg(typeid(DataT).name()) : drawConfigurationName)
{
