...
CT_ItemDrawableConfiguration CT_StandardGrid2DYZDrawManager<DataT>::createDrawConfiguration(QString drawConfigurationName) const
{
    ...
    item.addNewConfiguration(staticInitConfigMapModeXLevelEnabled(), "Mode Raster : Fixer le niveau X", CT_ItemDrawableConfiguration::Bool, false);
    item.addNewConfiguration(staticInitConfigMapModeXLevelValue(), "Mode Raster : Niveau X (m)", CT_ItemDrawableConfiguration::Double, 0);
    ...
    item.addNewConfiguration(staticInitConfig3DModeXMinScaleValue(), "Mode 3D    : X min de l'échelle (m)", CT_ItemDrawableConfiguration::Double, 0);
    item.addNewConfiguration(staticInitConfig3DModeXMaxScaleValue(), "Mode 3D    : X max de l'échelle (m)", CT_ItemDrawableConfiguration::Double, 5);
