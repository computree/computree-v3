...
public:
    ...
    CT_TransformationMatrix(const CT_OutAbstractSingularItemModel *model,
                         const CT_AbstractResult *result, const Eigen::Matrix3f &trMat);
    ...
    inline const Eigen::Matrix3f& getTransformationMatrix() const {return _transformationMatrix;}
...
protected:
    Eigen::Matrix3f     _transformationMatrix;
