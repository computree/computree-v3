...
private:
    ...
    CT_DEFAULT_IA_V2(CT_AbstractItemDrawableWithPointCloud, CT_AbstractCategory::staticInitDataCx(), &CT_AbstractItemDrawableWithPointCloud::getPointCloudIndexSize, QObject::tr("Nombre de points"))
