...
{
    PS_LOG->addMessage(LogInterface::info, LogInterface::step, "________________________________________");
    ...
    PS_LOG->addMessage(LogInterface::info, LogInterface::step, _counter->getTurnName());
}
